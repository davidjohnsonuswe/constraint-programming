...
/**
 * 
 * It models a Golomb_Jacop ruler problem.
 * 
 * @author Radoslaw Szymanek and Krzysztof Kuchcinski
 *
 * 
 *         Golomb_Jacop ruler is a special sequence of natural numbers
 *         an example is 0 1 4 6
 *
 *         a sequence is a Golomb_Jacop ruler if all differences are different
 *         (1-0), (4-0), (6-0), (4-1), (6-1), (6-4)
 *         1 4 6 3 5 2
 *         All differences above have different values
 *         A Golomb_Jacop ruler is optimal if the length of it (the last mark)
 *         has the smallest possible value
 *         The presented ruler with 4 marks of length 6 is optimal
 */

public class Golomb_Jacop {
  ...
  /**
   * It executes the program which computes the optimal Golomb_Jacop ruler.
   * 
  ...
  public static void main(String args[]) {
    Golomb_Jacop example = new Golomb_Jacop();
    example.model();
  }

  public void model() {
    System.out.println("Program to solve Golomb_Jacop mark problem - length "
        + noMarks);
    ...
    for (int i = 0; i < numbers.length; i++) {
      ...
      // Golomb_Jacop ruler is an ordered sequence of numbers
      if (i > 0)
    ...
    SelectChoicePoint<IntVar> select = 
            new InputOrderSelect<IntVar>(store, 
                                   numbers, new IndomainMin<IntVar>()); 
