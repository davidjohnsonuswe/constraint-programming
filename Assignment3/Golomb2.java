...
/**
 * 
 * It models a Golomb2 ruler problem.
 * 
 * @author Radoslaw Szymanek and Krzysztof Kuchcinski
 *
 * 
 *         Golomb2 ruler is a special sequence of natural numbers
 *         an example is 0 1 4 6
 *
 *         a sequence is a Golomb2 ruler if all differences are different
 *         (1-0), (4-0), (6-0), (4-1), (6-1), (6-4)
 *         1 4 6 3 5 2
 *         All differences above have different values
 *         A Golomb2 ruler is optimal if the length of it (the last mark)
...
public class Golomb2 {
  ...
  /**
   * It executes the program which computes the optimal Golomb2 ruler.
   * 
  ...
  public void model() {
    System.out.println("Program to solve Golomb2 mark problem - length "
        + noMarks);
    ...
    for (int i = 0; i < numbers.length; i++) {
      ...
      // Golomb2 ruler is an ordered sequence of numbers
      if (i > 0)
